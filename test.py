...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr, fc_x, fc_y, tc_x, tc_y, jc_x, jc_y):
        ...
        self.Delta_C1 = 1.2 # cost intensive area 1 modifier
        self.Delta_C2 = 1.4 # cost intensive area 2 modifier
        self.Delta_C3 = 0.5 # cost jet area modifier
...
def main():
    ...
    if show_animation:  # pragma: no cover
        ...
        plt.plot(jc_x, jc_y, "xb") # plot jet area
